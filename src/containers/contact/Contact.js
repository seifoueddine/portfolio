            ...
            {/* <div className="row"> */}
                <div className="contact-header">
                    ...
                    <div className="contact-text-div">
                        <a className="contact-detail" href={"tel:" + contactInfo.number}>{contactInfo.number}</a> / <a className="contact-detail" href={"tel:" + contactInfo.number2}>{contactInfo.number2}</a>
                        <br/><br/>
